  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Hero + CTAs */}
        <section className="pt-12 lg:pt-20 pb-8" aria-label="Hero">
          <div className="text-center">
            <h1 className="text-4xl lg:text-5xl font-bold text-secondary-900 dark:text-white leading-tight tracking-tight max-w-3xl mx-auto">
              Buying or selling online?{' '}
              <span className="text-primary-500">Your money deserves protection.</span>
            </h1>
            <p className="mt-4 text-lg lg:text-xl text-secondary-600 dark:text-secondary-300 leading-relaxed max-w-2xl mx-auto">
              {siteName} holds payments in trust until delivery is confirmed. If something goes wrong, built-in dispute resolution has you covered.
            </p>
            <div className="mt-4 flex items-center justify-center gap-4 text-sm text-secondary-500 dark:text-secondary-400">
              <span>1% fee</span>
          ...
          {isConnected ? (
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* P2P users */}
              <div className="border border-primary-200 dark:border-primary-700 rounded-xl p-6 bg-white dark:bg-secondary-800 hover:border-primary-400 dark:hover:border-primary-500 transition-colors">
                <h3 className="text-lg font-semibold text-secondary-900 dark:text-white mb-1">
                  Send or Request Payment
                </h3>
                <p className="text-sm text-secondary-600 dark:text-secondary-400 mb-4">
                  Social ID, passwordless email or existing wallet
                </p>
                <ConnectWalletEmbedded
                  useSmartRouting={false}
                  showTwoOptionLayout={true}
                />
                <div className="mt-3 flex flex-wrap gap-3 text-xs text-secondary-600 dark:text-secondary-400">
              ...
              {/* Merchants */}
              <div className="border border-green-200 dark:border-green-700 rounded-xl p-6 bg-white dark:bg-secondary-800 hover:border-green-400 dark:hover:border-green-500 transition-colors">
                <h3 className="text-lg font-semibold text-secondary-900 dark:text-white mb-1">
                  Add Escrow Checkout to Your Site
                </h3>
                <p className="text-sm text-secondary-600 dark:text-secondary-400 mb-4">
                  Self-install in 10 minutes. WordPress, Shopify, or custom JS.
                </p>
                <Link href="/plugins">
                ...
                <Link href="/merchant-savings-calculator">
                  <span className="inline-block mt-3 text-xs text-green-700 dark:text-green-400 font-medium hover:underline">
        ...
        <section className="mt-16 lg:mt-20" aria-label="Escrow Process Steps">
          <h2 className="text-4xl lg:text-5xl font-bold text-secondary-900 dark:text-white text-center mb-12 tracking-tight">
            Simple 3-Step Process
          </h2>
          <div className="relative">
            {/* Connection line */}
            <div className="hidden md:block absolute top-6 left-1/4 right-1/4 h-0.5 bg-primary-200 dark:bg-primary-800"></div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
              <div className="bg-white dark:bg-secondary-800 border border-secondary-200 dark:border-secondary-700 rounded-xl p-6 lg:p-8 hover:border-primary-300 dark:hover:border-primary-600 transition-colors">
                <div className="w-12 h-12 bg-primary-500 text-white rounded-full flex items-center justify-center mb-6 text-xl font-bold">
                  1
                </div>
                <h3 className="text-lg font-semibold text-secondary-900 dark:text-white mb-3">Seller creates payment request</h3>
                <p className="text-secondary-600 dark:text-secondary-400 leading-relaxed">with delivery timeframe</p>
              </div>
              ...
              <div className="bg-white dark:bg-secondary-800 border border-secondary-200 dark:border-secondary-700 rounded-xl p-6 lg:p-8 hover:border-primary-300 dark:hover:border-primary-600 transition-colors">
                ...
                <h3 className="text-lg font-semibold text-secondary-900 dark:text-white mb-3">Buyer puts funds in secure trust</h3>
                <p className="text-secondary-600 dark:text-secondary-400 leading-relaxed">Money goes into secure trust, not directly to seller</p>
              </div>
              ...
              <div className="bg-white dark:bg-secondary-800 border border-secondary-200 dark:border-secondary-700 rounded-xl p-6 lg:p-8 hover:border-primary-300 dark:hover:border-primary-600 transition-colors">
                ...
                <h3 className="text-lg font-semibold text-secondary-900 dark:text-white mb-3">Automatic payout to seller</h3>
                <p className="text-secondary-600 dark:text-secondary-400 leading-relaxed">Seller receives payment at pre-agreed date. Disputed transactions held in trust until resolution.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        {!isConnected && (
          <>
            {/* Section 4: Dispute Resolution — consolidated */}
            <section className="mt-16 lg:mt-20 bg-secondary-50 dark:bg-secondary-800 rounded-2xl p-8 lg:p-12" aria-label="Dispute Resolution">
              <div className="grid lg:grid-cols-2 gap-10">
                {/* Left: compact 3-step timeline */}
                <div>
                  <h2 className="text-3xl lg:text-4xl font-bold text-secondary-900 dark:text-white mb-2 tracking-tight">What if there&#39;s a problem?</h2>
                  <p className="text-lg text-secondary-600 dark:text-secondary-400 mb-8">Built-in dispute resolution protects both sides.</p>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-secondary-900 dark:text-white">Buyer raises a dispute</h3>
                        <p className="text-sm text-secondary-600 dark:text-secondary-400">Before payout date. Funds freeze immediately.</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-secondary-900 dark:text-white">Both sides negotiate</h3>
                        <p className="text-sm text-secondary-600 dark:text-secondary-400">Each proposes a fair split. No fees, no middlemen.</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-secondary-900 dark:text-white">Automatic payout on agreement</h3>
                        <p className="text-sm text-secondary-600 dark:text-secondary-400">Smart contract distributes funds per the agreed split.</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-secondary-900 rounded-xl border border-secondary-200 dark:border-secondary-700 overflow-hidden">
                  <div className="grid grid-cols-3 text-sm">
                    {/* Header */}
                    <div className="p-4 bg-secondary-100 dark:bg-secondary-800 font-semibold text-secondary-700 dark:text-secondary-300"></div>
                    <div className="p-4 bg-secondary-100 dark:bg-secondary-800 font-semibold text-secondary-700 dark:text-secondary-300 text-center">Traditional</div>
                    <div className="p-4 bg-primary-50 dark:bg-primary-900/30 font-semibold text-primary-700 dark:text-primary-300 text-center">{siteName}</div>

                    {/* Dispute fee */}
                    <div className="p-4 border-t border-secondary-200 dark:border-secondary-700 font-medium text-secondary-700 dark:text-secondary-300">Dispute fee</div>
                    <div className="p-4 border-t border-secondary-200 dark:border-secondary-700 text-center text-secondary-600 dark:text-secondary-400">$15–25</div>
                    <div className="p-4 border-t border-secondary-200 dark:border-secondary-700 text-center text-primary-600 dark:text-primary-400 font-medium">$0</div>

                    {/* Seller voice */}
                    <div className="p-4 border-t border-secondary-200 dark:border-secondary-700 font-medium text-secondary-700 dark:text-secondary-300">Seller voice</div>
                    <div className="p-4 border-t border-secondary-200 dark:border-secondary-700 text-center text-secondary-600 dark:text-secondary-400">None</div>
                    <div className="p-4 border-t border-secondary-200 dark:border-secondary-700 text-center text-primary-600 dark:text-primary-400 font-medium">Equal negotiation</div>

                    {/* Window */}
                    <div className="p-4 border-t border-secondary-200 dark:border-secondary-700 font-medium text-secondary-700 dark:text-secondary-300">Dispute window</div>
                    <div className="p-4 border-t border-secondary-200 dark:border-secondary-700 text-center text-secondary-600 dark:text-secondary-400">180 days</div>
                    <div className="p-4 border-t border-secondary-200 dark:border-secondary-700 text-center text-primary-600 dark:text-primary-400 font-medium">Before payout only</div>

                    {/* Fund safety */}
                    <div className="p-4 border-t border-secondary-200 dark:border-secondary-700 font-medium text-secondary-700 dark:text-secondary-300">Fund safety</div>
                    <div className="p-4 border-t border-secondary-200 dark:border-secondary-700 text-center text-secondary-600 dark:text-secondary-400">Bank decides</div>
                    <div className="p-4 border-t border-secondary-200 dark:border-secondary-700 text-center text-primary-600 dark:text-primary-400 font-medium">Smart contract</div>
                  </div>
                </div>
              </div>
            </section>

            {/* Section 5: Trust & Open Source — compact band */}
            <section className="mt-16 lg:mt-20" aria-label="Open Source Security">
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium text-secondary-900 dark:text-white">Every line public</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="w-6 h-6 text-primary-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z" />
                  </svg>
                  <span className="text-sm font-medium text-secondary-900 dark:text-white">Community audited</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="w-6 h-6 text-primary-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-sm font-medium text-secondary-900 dark:text-white">Immutable contracts</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="w-6 h-6 text-primary-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M12.316 3.051a1 1 0 01.633 1.265l-4 12a1 1 0 11-1.898-.632l4-12a1 1 0 011.265-.633zM5.707 6.293a1 1 0 010 1.414L3.414 10l2.293 2.293a1 1 0 11-1.414 1.414l-3-3a1 1 0 010-1.414l3-3a1 1 0 011.414 0zm8.586 0a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 11-1.414-1.414L16.586 10l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                  </svg>
                  <span className="text-sm font-medium text-secondary-900 dark:text-white">MIT licensed</span>
                </div>
              </div>
            ...
            {/* Section 6: Pricing */}
            <section className="mt-16 lg:mt-20" aria-label="Pricing">
              <div className="bg-white dark:bg-secondary-800 border border-secondary-200 dark:border-secondary-700 rounded-xl p-8 lg:p-10 max-w-lg mx-auto text-center">
                <h2 className="text-4xl lg:text-5xl font-bold text-primary-600 dark:text-primary-400 tracking-tight">1%</h2>
                <p className="mt-1 text-lg text-secondary-900 dark:text-white font-medium">per transaction</p>
                <p className="mt-4 text-secondary-600 dark:text-secondary-400">No monthly fees. No setup fees. No dispute fees.</p>
                <Link href="/merchant-savings-calculator" className="mt-4 inline-block text-sm font-medium text-primary-500 hover:text-primary-600 dark:hover:text-primary-400">
                  Calculate your savings vs. traditional processors →
                </Link>
              </div>
            </section>

            {/* Section 7: Questions / Contact */}
            <section className="mt-16 lg:mt-20 mb-12 text-center" aria-label="Contact">
