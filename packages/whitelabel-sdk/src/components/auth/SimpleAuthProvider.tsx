...
const defaultAuthValue = {
  ...
  canFundWallet: () => false,
  fundWallet: async () => null,
  canExportWallet: () => false,
  exportWallet: async () => { throw new Error('Auth not ready'); },
  updateUserData: () => {},
...
function AuthWrapper({ children }: { children: React.ReactNode }) {
  ...
  const authValue = React.useMemo(() => ({
    ...
    canFundWallet: newAuth.canFundWallet,
    fundWallet: newAuth.fundWallet,
    canExportWallet: newAuth.canExportWallet,
    exportWallet: newAuth.exportWallet,
