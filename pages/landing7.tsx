        ...
        <section className="min-h-[90vh] flex items-center" aria-label="Hero">
          <div className="max-w-5xl mx-auto px-6 sm:px-8 py-24 lg:py-32 w-full">
            <motion.div variants={heroStagger} initial="hidden" animate="show">
              ...
              <motion.div variants={heroChild} className="mt-8 max-w-md">
                <div className="rounded-2xl border-2 border-primary-500 bg-white dark:bg-secondary-900 p-6 sm:p-7 shadow-sm">
                  <h2 className="text-xl sm:text-2xl font-semibold text-secondary-900 dark:text-white tracking-tight">
                    Get paid in stablecoins
                  </h2>
                  <p className="mt-3 text-sm text-secondary-500 dark:text-secondary-400 leading-relaxed">
                    Request payment. No chargebacks.
                  </p>
                  <Link href="/create" className="mt-6 block">
                    <button className={`${btnOutline} w-full justify-center`}>
                      Request payment
                    </button>
                  </Link>
                </div>
